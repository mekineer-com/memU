...
def test_split_context_queries_route_keeps_history_downstream_drops_it():
    queries = [
        {"role": "all_categories_summary", "content": {"text": "cats"}},
        {"role": "history_from_chat_x", "content": {"text": "history"}},
    ...
    assert [q.get("role") for q in downstream_ctx] == ["all_categories_summary", "memory_cache"]
